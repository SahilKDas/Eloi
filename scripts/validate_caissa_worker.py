...
def probe(executable: Path, crash: bool, timeout: float) -> dict:
    ...
    expected_detail = (
        "Caissa worker pipe closed after crash or exit" if crash else ""
    )
    ...
    return {
        ...
        "expected_detail_seen": detail_ok,
        "transcript": transcript,
        "passed": (
            legal_move and exit_code == 0 and detail_ok
        ),
    }
